...
class PropertyTable:
    ...
    full_property_list = {
        ...
        "Xraylum_core_excision": (
            ...
            np.float64,
            "erg/s",
            "Total rest-frame Xray luminosity in three bands. Excludes gas in the inner 0.15 R500c",
            "gas",
            "DMantissa9",
            False,
        ),
        "Xraylum_no_agn_core_excision": (
            ...
            np.float64,
            "erg/s",
            "Total rest-frame Xray luminosity in three bands. Excludes gas that was recently heated by AGN. Excludes gas in the inner 0.15 R500c",
            "gas",
            "DMantissa9",
            False,
        ),
        ...
        "Xrayphlum_core_excision": (
            ...
            np.float64,
            "1/s",
            "Total rest-frame Xray photon luminosity in three bands. Excludes gas in the inner 0.15 R500c",
            "gas",
            "DMantissa9",
            False,
        ),
        "Xrayphlum_no_agn_core_excision": (
            ...
            np.float64,
            "1/s",
            "Total rest-frame Xray photon luminosity in three bands. Exclude gas that was recently heated by AGN. Excludes gas in the inner 0.15 R500c",
            "gas",
            "DMantissa9",
            False,
        ),
        ...
        "SpectroscopicLikeTemperature_core_excision": (
            ...
            np.float32,
            "K",
            "Spectroscopic-like gas temperature. Excludes gas in the inner 0.15 R500c",
            "gas",
            "FMantissa9",
            False,
        ),
        "SpectroscopicLikeTemperature_no_agn_core_excision": (
            ...
            np.float32,
            "K",
            "Spectroscopic-like gas temperature. Exclude gas that was recently heated by AGN. Excludes gas in the inner 0.15 R500c",
            "gas",
            "FMantissa9",
            False,
        ),
