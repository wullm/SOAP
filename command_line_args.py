...
def get_halo_props_args(comm):
    ...
    if comm.Get_rank() == 0:
        ...
        parser.add_argument(
            "halo_format", help="Type of halo finder in use (VR, HBTplus or Gadget4)"
        )
        parser.add_argument(
            "output_file",
        ...
        parser.add_argument(
            "--halo-size-file",
            type=str,
            help="File with number of particles per halo (generated by group_mmebership.py)",
        )
        try:
...
def get_group_membership_args(comm):
    ...
    if comm.Get_rank() == 0:
        ...
        parser.add_argument(
            "halo_format", help="Type of halo finder in use (VR or HBTplus)"
        )
        parser.add_argument(
            "output_file",
        ...
        parser.add_argument(
            "--virtual-snapshot",
            type=str,
            help="Create a virtual snapshot with group membership info",
        )
        parser.add_argument(
            "--output-prefix",
            type=str,
        ...
        parser.add_argument(
            "--host-ids",
            action="store_true",
            help="Also output host halo membership given by VR's hostHaloID",
        )
        try:
            args = parser.parse_args()
        except ArgumentParserError as e:
