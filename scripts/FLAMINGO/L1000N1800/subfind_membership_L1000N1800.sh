...
# cd SOAP
# mkdir logs
# sbatch -J HYDRO_FIDUCIAL --array=0-77%4 ./scripts/FLAMINGO/L1000N1800/subfind_membership_L1000N1800.sh
#
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --ntasks=128
#SBATCH -o ./logs/subfind_membership_L1000N1800_%x.%a.out
#SBATCH -p cosma8
#SBATCH -A dp004
#SBATCH --exclusive
#SBATCH -t 0:30:00
...
mpirun python3 -u -m mpi4py ./group_membership.py \
       ./scripts/FLAMINGO/L1000N1800/subfind_parameters.yml --sim-name=${sim} --snap-nr=${snapnum}
