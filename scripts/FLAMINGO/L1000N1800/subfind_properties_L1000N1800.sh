...
# cd SOAP
# mkdir logs
# sbatch -J HYDRO_FIDUCIAL --array=0-77%4 ./scripts/FLAMINGO/L1000N1800/subfind_properties_L1000N1800_HYDRO.sh
#
#SBATCH --nodes=4
#SBATCH --cpus-per-task=1
#SBATCH -o ./logs/subfind_properties_L1000N1800_%x.%a.out
#SBATCH -p cosma8
#SBATCH -A dp004
#SBATCH --exclusive
#SBATCH -t 12:00:00
...
mpirun python3 -u -m mpi4py ./compute_halo_properties.py \
       ./scripts/FLAMINGO/L1000N1800/subfind_parameters.yml \
