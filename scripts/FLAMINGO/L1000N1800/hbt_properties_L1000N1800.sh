...
outbase="/cosma8/data/dp004/jch/FLAMINGO/ScienceRuns/${sim}/HBT/SOAP/"
...
hbt_basename="/snap8/scratch/dp004/jch/FLAMINGO/HBT/L1000N1800_HYDRO_FIDUCIAL/hbt/%(snap_nr)03d/SubSnap_%(snap_nr)03d"
...
mpirun python3 -u -m mpi4py ./compute_halo_properties.py \
    ${swift_filename} ${scratchdir} ${hbt_basename} HBTplus ${outfile} ${SLURM_ARRAY_TASK_ID} \
    --chunks=${nr_chunks} \
