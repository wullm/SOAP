...
class SOProperties(HaloProperty):
    ...
    def __init__(self, SOval, type="mean"):
    ...
    def calculate(
        self, index, unit_registry, critical_density, mean_density, a, z, centre, data
    ):
        """
        ...
        if self.type == "crit":
            reference_density = self.critical_density_multiple * critical_density
            ...
            reference_density = self.mean_density_multiple * mean_density
