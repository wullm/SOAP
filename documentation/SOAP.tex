...
\paragraph{Some properties (currently just the subhalo ranking by mass) are computed by SOAP from other halo properties.} These are stored in a separate group, \verb+SOAP+. This is just done for convenience; these quantities can be computed from the SOAP output alone.
